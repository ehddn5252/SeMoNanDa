...
public class TopicsWinnerRes{
	...
	int teamBWinCount;
	@ApiModelProperty(name="winner user ID")
	String userId;
	@ApiModelProperty(name="winner user nickname")
	String userNickname;
	
	
	public static TopicsWinnerRes of(GameCategoryTopic topic, User user) {
		TopicsWinnerRes res = new TopicsWinnerRes();
